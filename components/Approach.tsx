            ...
            <div className="my-20 flex flex-col lg:flex-row items-center justify-center  w-full gap-4 mx-auto px-8">
                {
                    [
                        ...
                        <Card
                            ...
                            title={title}
                            description={desc}
                            icon={<AceternityIcon {...{ phase }} />}>
                            <CanvasRevealEffect
                                animationSpeed={5.1}
                                containerClassName={`${colorClass} rounded-3xl overflow-hidden`}
                                colors={colors}
                            />
                        </Card>
        ...
        <div
            ...
            className="border border-black/[0.2] group/canvas-card flex items-center
             justify-center dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4
               lg:h-[35rem] relative rounded-3xl"
        >
...
const AceternityIcon = ({ phase }: { phase: string }) => {
    return (
        <div>
